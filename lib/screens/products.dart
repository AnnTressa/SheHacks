              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                      ...
                      child: Column(
                    children: const [
                      Text('Wood Dining Chair',
                        style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.brown),
                      ),
                      Text('₹7,950',
                        style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,color: Colors.brown),
                       ),
                    ],
                  ))
                  ),
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                      ...
                      child: Column(
                    children: const [
                      Text('Wood TV Entertainment Unit',
                        style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.brown),
                      ),
                      Text('₹5,790',
                        style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,color: Colors.brown),
